...
public class ProductManager {
    ...
    // Method to remove a product (prevents removal if the product exists in an order)
    public void removeProduct(int productId, List<Order> orders) throws ProductException {
        ...
        // Check if product is part of any existing order
    ...
    // Method to search products by category (assuming a category field exists in the Product class)
    ...
    // Method to reduce product inventory when an order is placed
    public void processOrder(int productId, int quantity) throws ProductException {
        ...
        Product product = productOpt.get();
        product.reduceInventory(quantity);  // Reduce inventory based on the quantity ordered
    }
}
