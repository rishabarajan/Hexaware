...
public class Product {
    ...
    // ✅ Newly Added Methods for Compatibility
    public int getInventory() {
        return stockQuantity;
    }

    public String getDescription() {
        return category; // Assuming category acts as a description
    }

    // ✅ Setter methods (Existing + Fixed Compatibility)
